...
function catalogue(hash, imdb, magnet, title, rating, poster, genre, background, api_url, provider, proxy, content_value) {
	...
	//html+='<a href="'+magnet+'">';
	html+='<img id="img-movie-box-'+hash+'" class="hover-luz" title="'+title+'" alt="'+title+'" src="'+poster+'" onclick="iframeHash(&#39;'+magnet+'&#39;)" data-toggle="modal" data-target="#myModal" onmouseover="hoverHash(&#39;'+imdb+'&#39;)" onmouseout="outHash(&#39;'+imdb+'&#39;)"/>';
...
function iframeHash(magnet) {
	...
	$('#movies').append('<embed src="'+magnet+'" frameborder="0"></embed>');
	$('#modalBodyPlayer').append('<embed src="'+magnet+'" frameborder="0"></embed>');	
}